    ...
    @php
        ...
        $fieldDefs = [
            ...
            'surat_kuasa' => [
                ...
                ['key' => 'no_do',              'label' => 'No. Delivery Order (DO)', 'type' => 'text'],
                ['key' => 'no_kontrak',         'label' => 'No. Kontrak',            'type' => 'text'],
                ['key' => 'jumlah_kg',          'label' => 'Total Muatan (kg)',      'type' => 'number'],
                ['key' => 'jasa_expedisi',      'label' => 'Jasa Ekspedisi',         'type' => 'text'],
                ['key' => 'nama_penerima',      'label' => 'Nama Supir',             'type' => 'text'],
                ['key' => 'no_kendaraan',       'label' => 'No. Polisi / Plat',      'type' => 'text'],
            ],
        ];
                        ...
                        <div>
                            @if(isset($mode) && $mode === 'manual')
                                <div style="display:flex; align-items:center;">
                                    <select onchange="window.location.href='{{ route('ocr.manual') }}?type={{ $type }}&jenis=' + this.value" class="bg-white border border-slate-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2 px-3 font-bold text-slate-700 shadow-sm" style="padding-right: 32px">
                                        @if($type == 'outbound')
